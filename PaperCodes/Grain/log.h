...
inline void loggerRes(string logMsg, int rounds)
{
    string filePath = "./TERM/RES_" + to_string(rounds) + ".log";
    ofstream os(filePath.c_str(), ios_base::out | ios_base::app);
...
inline void loggerExpandTerms(string logMsg, int rounds)
{
    string filePath = "./TERM/EXT_" + to_string(rounds) + ".log";
    ofstream os(filePath.c_str(), ios_base::out | ios_base::app);
...
{
    string filePath = "./TERM/term_" + to_string(rounds) + ".log";
    ofstream os(filePath.c_str(), ios_base::out | ios_base::app);
